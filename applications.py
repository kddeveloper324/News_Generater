...
def get_weather(city: str):
    ...
    """
    try:
        api_key="3cc27b018d47f5d4a8e9eb897da4331c"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="f3114a508cac4e2e8731fd909e983cfb"
...
def find_local_events(city: str):
    ...
    try:
        api_key="66cb55bf10d322984449b41723014644abaa3080e58b3aa8fb08ad890b32fff6"
